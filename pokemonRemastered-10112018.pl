...
pokemonesconBill([]).
pokemonesJugador([[pikachu,  electrico,60,[ impactrueno,   cabezazo,	tacleada,	chispa],    muerto, 1, 0],
				[voltorb,  electrico,10,[ agilidad,      destello,   impactrueno,chispa],	muerto, 1, 0]]).
huevosJugador([[electrico,80],[electrico,80],[electrico,80],[electrico,80]]). %Huevos Iniciales
...
%Al vencer el Pokemon enemigo se pregunta si lo quiere capturar
